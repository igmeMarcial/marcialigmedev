      ...
      <div className='igme__skills-cotainer '>
          <div className='igme__skills-wrap app__flex'>
              <div className='carousel-container '>
                  <motion.h5 variants={explainPhrase} initial="hidden" animate="show" className='igme__title'>Skills:</motion.h5>
                  <div className='skill-carousel'>
                      <motion.div  variants={skillAnimation} initial="hidden" animate='show'   className='wrap-item'>
                     {
                          skills.map((item, index) => (
                              <motion.div variants={skillItem} key={index} className="skill-item">
                                  <img src={item.srcImg} />
                              </motion.div>
                          ))
                      }
