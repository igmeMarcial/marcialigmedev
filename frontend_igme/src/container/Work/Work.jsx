...
function Work() {
  ...
  return (
      <motion.div id='work' initial="hidden"
      animate="visible"
      exit={{ opacity: 0, transition: { duration: 1 } }}
          variants={{ visible: { transition: { staggerChildren: 0.3 } } }} className='igme__work'>
          {/* <Fade left> */}
              <h2 className=" igme__title title-works">Some things I've <span>worked</span> on</h2>
          {/* </Fade> */}
